...
function show_all_tasks() {
    ...
    document.getElementById("OngoingTasksDiv").style.display = "none";
    document.getElementById("FinishedTasksDiv").style.display = "none";
}

function show_ongoing_tasks() {
    document.getElementById("AllTasksDiv").style.display = "none";
    document.getElementById("OngoingTasksDiv").style.display = "block";
    document.getElementById("FinishedTasksDiv").style.display = "none";
}
...
function show_finished_tasks() {
    document.getElementById("AllTasksDiv").style.display = "none";
    document.getElementById("OngoingTasksDiv").style.display = "none";
    document.getElementById("FinishedTasksDiv").style.display = "block";
}    
